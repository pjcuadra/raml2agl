...
# Configure Breathe
breathe_projects = {"raml2agl": os.path.join(os.path.dirname(__file__),
                                             '_static/src/xml')}

breathe_default_project = "raml2agl"
...
# Workaround for using Plantuml over plantweb
plantuml = os.path.join(os.path.dirname(__file__), 'plantuml.sh')

# Set figure to have numbers
numfig = True
